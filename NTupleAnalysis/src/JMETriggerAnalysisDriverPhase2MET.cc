...
JMETriggerAnalysisDriverPhase2MET::JMETriggerAnalysisDriverPhase2MET(const std::string& tfile,
...
JMETriggerAnalysisDriverPhase2MET::JMETriggerAnalysisDriverPhase2MET(const std::string& outputFilePath,
                                                                     const std::string& outputFileMode)
...
void JMETriggerAnalysisDriverPhase2MET::analyze() {
  ...
  if (L1T_PFPuppiMET200off)
    fillHistograms("L1T_PFPuppiMET200off", wgt);
  if (L1T_PFPuppiMET200off2)
    fillHistograms("L1T_PFPuppiMET200off2", wgt);
  if (L1T_PFPuppiMET220off2)
    fillHistograms("L1T_PFPuppiMET220off2", wgt);
  if (L1T_PFPuppiMET250off2)
    fillHistograms("L1T_PFPuppiMET250off2", wgt);
}
...
void JMETriggerAnalysisDriverPhase2MET::bookHistograms(const std::string& dir) {
  ...
  for (uint idx = 0; idx < binEdges_pt_2.size(); ++idx) {
    binEdges_pt_2.at(idx) = 100. + idx * 5.;
  }
