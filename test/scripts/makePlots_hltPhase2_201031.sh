...
inpdir=${JMEANA_BASE}/output_hltPhase2_201022_v2
outdir=plots_hltPhase2_201022_v2
...
for sample in "${samples[@]}"; do
  ...
  jmePlots.py -k phase2_jme_compareL1T ${opts_i} \
    -o ${outd_i}/compareL1T -l ${sample} -e ${exts[*]} -i \
    ${inpdir}/harvesting/HLT_TRKv06p1/${sample}.root:'':1:1:20

  jmePlots.py -k phase2_jme_comparePFPuppi ${opts_i} \
    -o ${outd_i}/compareHGCal_TRKv06p1 -l ${sample} -e ${exts[*]} -i \
    ${inpdir}/harvesting/HLT_TRKv06p1/${sample}.root:'TRK-v6.1 + simPF':1:1:20 \
    ${inpdir}/harvesting/HLT_TRKv06p1_TICL/${sample}.root:'TRK-v6.1 + TICLold':2:1:22 \
    ${inpdir}/harvesting/HLT_TRKv06p1_TICLv2/${sample}.root:'TRK-v6.1 + TICLnew':4:1:33

  jmePlots.py -k phase2_jme_comparePFPuppi ${opts_i} \
    -o ${outd_i}/compareHGCal_TRKv07p2 -l ${sample} -e ${exts[*]} -i \
    ${inpdir}/harvesting/HLT_TRKv07p2/${sample}.root:'TRK-v7.2 + simPF':920:1:20 \
    ${inpdir}/harvesting/HLT_TRKv07p2_TICL/${sample}.root:'TRK-v7.2 + TICLold':801:1:22 \
    ${inpdir}/harvesting/HLT_TRKv07p2_TICLv2/${sample}.root:'TRK-v7.2 + TICLnew':879:1:33

  jmePlots.py -k phase2_jme_comparePFPuppi ${opts_i} \
    -o ${outd_i}/compareTRK_simPF -l ${sample} -e ${exts[*]} -i \
    ${inpdir}/harvesting/HLT_TRKv06p1/${sample}.root:'TRK-v6.1 + simPF':1:1:20 \
    ${inpdir}/harvesting/HLT_TRKv07p2/${sample}.root:'TRK-v7.2 + simPF':920:1:20 \

  jmePlots.py -k phase2_jme_comparePFPuppi ${opts_i} \
    -o ${outd_i}/compareTRK_TICLv2 -l ${sample} -e ${exts[*]} -i \
    ${inpdir}/harvesting/HLT_TRKv06p1_TICLv2/${sample}.root:'TRK-v6.1 + TICLnew':4:1:33 \
    ${inpdir}/harvesting/HLT_TRKv07p2_TICLv2/${sample}.root:'TRK-v7.2 + TICLnew':879:1:33
