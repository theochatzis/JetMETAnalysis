...
inpdir=${JMEANA_BASE}/output_hltPhase2_201119_patatrack
outdir=plots_hltPhase2_201119_patatrack
...
for sample in "${samples[@]}"; do
  ...
  jmePlots.py -k phase2_jme_comparePFPuppi ${opts_i} \
    ...
    ${inpdir}/harvesting/HLT_TRKv06p1_TICL/${sample}.root:'TRK-v6.1 + TICL':1:1:20 \
    ${inpdir}/harvesting/HLT_TRKv06p3_TICL/${sample}.root:'TRK-v6.3 + TICL':2:1:24

  jmePlots.py -k phase2_jme_compareTRK1 ${opts_i} \
    -o ${outd_i}/compareTRK1_TRKv06p1_TICL -l ${sample} -e ${exts[*]} -i \
    ${inpdir}/harvesting/HLT_TRKv06p1_TICL/${sample}.root:'TRK-v6.1 + TICL':1:1:20

  jmePlots.py -k phase2_jme_compareTRK1 ${opts_i} \
    -o ${outd_i}/compareTRK1_TRKv06p3_TICL -l ${sample} -e ${exts[*]} -i \
    ${inpdir}/harvesting/HLT_TRKv06p3_TICL/${sample}.root:'TRK-v6.3 + TICL':2:1:24
