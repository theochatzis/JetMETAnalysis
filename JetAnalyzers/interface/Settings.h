...
const char eta_boundaries[NETA+1][10] = {
 "-5.1",
 "-4.8",
 "-4.5",
 "-4.2",
...
const char eta_boundaries_coarse[NETA_Coarse+1][10] = {"-5","-3","-2.5","-1.5","0","1.5","2.5","3","5"};
...
const TString jet_types[NJetTypes] = {"Calo", "JPT", "TRK", "PF", "PFchs", "PFPuppi", "PUPPI",
               "CaloHLT", "PFHLT", "PFchsHLT", "JPTHLT", "PFPuppiHLT", "PFClusterHLT",
               "tau",
