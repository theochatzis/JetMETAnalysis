...
if __name__ == '__main__':
   ...
   for _hkey in th1Keys:
       ...
       if _hIsProfile:
          ...
          elif _hkey_basename.endswith('hltVerticesPF_mult'): _titleX = '#hltVerticesPF'
       else:
          if 'MET' in _hkey_basename: _titleY = 'Events'
          elif 'Jets' in _hkey_basename: _titleY = 'Entries'

       if 'pt_paraToOffline_Mean' in _hkey_basename: _titleY = '<p_{T}^{#parallel Offl}> [GeV]'
       elif 'pt_paraToOffline_RMS' in _hkey_basename: _titleY = '#sigma(p_{T}^{#parallel Offl}) [GeV]'
       elif 'pt_paraToOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(p_{T}^{#parallel Offl}) / <p_{T} / p_{T}^{Offl}> [GeV]'
       elif 'pt_paraToOffline' in _hkey_basename: _titleX = 'p_{T}^{#parallel Offl} [GeV]'

       elif 'pt_paraToOfflineMinusOffline_Mean' in _hkey_basename: _titleY = '<p_{T}^{#parallel Offl} - p_{T}^{Offl}> [GeV]'
       elif 'pt_paraToOfflineMinusOffline_RMS' in _hkey_basename: _titleY = '#sigma(p_{T}^{#parallel Offl} - p_{T}^{Offl}) [GeV]'
       elif 'pt_paraToOfflineMinusOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(p_{T}^{#parallel Offl} - p_{T}^{Offl}) / <p_{T} / p_{T}^{Offl}> [GeV]'
       elif 'pt_paraToOfflineMinusOffline' in _hkey_basename: _titleX = 'p_{T}^{#parallel Offl} - p_{T}^{Offl} [GeV]'

       elif 'pt_perpToOffline_Mean' in _hkey_basename: _titleY = '<p_{T}^{#perp Offl}> [GeV]'
       elif 'pt_perpToOffline_RMS' in _hkey_basename: _titleY = '#sigma(p_{T}^{#perp Offl}) [GeV]'
       elif 'pt_perpToOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(p_{T}^{#perp Offl}) / <p_{T} / p_{T}^{Offl}> [GeV]'
       elif 'pt_perpToOffline' in _hkey_basename: _titleX = 'p_{T}^{#perp Offl} [GeV]'

       elif 'pt_minusGEN_Mean' in _hkey_basename: _titleY = '<p_{T} - p_{T}^{GEN}> [GeV]'
       elif 'pt_minusGEN_RMS' in _hkey_basename: _titleY = '#sigma(p_{T} - p_{T}^{GEN}) [GeV]'
       elif 'pt_minusGEN_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(p_{T} - p_{T}^{GEN}) / <p_{T} / p_{T}^{GEN}> [GeV]'
       elif 'pt_minusGEN' in _hkey_basename: _titleX = 'p_{T} - p_{T}^{GEN} [GeV]'

       elif 'pt_overGEN_Mean' in _hkey_basename: _titleY = '<p_{T} / p_{T}^{GEN}>'
       elif 'pt_overGEN_RMS' in _hkey_basename: _titleY = '#sigma(p_{T} / p_{T}^{GEN})'
       elif 'pt_overGEN_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(p_{T} / p_{T}^{GEN}) / <p_{T} / p_{T}^{GEN}>'
       elif 'pt_overGEN' in _hkey_basename: _titleX = 'p_{T} / p_{T}^{GEN}'

       elif 'pt_minusOffline_Mean' in _hkey_basename: _titleY = '<p_{T} - p_{T}^{Offl}> [GeV]'
       elif 'pt_minusOffline_RMS' in _hkey_basename: _titleY = '#sigma(p_{T} - p_{T}^{Offl}) [GeV]'
       elif 'pt_minusOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(p_{T} - p_{T}^{Offl}) / <p_{T} / p_{T}^{Offl}> [GeV]'
       elif 'pt_minusOffline' in _hkey_basename: _titleX = 'p_{T} - p_{T}^{Offl} [GeV]'

       elif 'pt_overOffline_Mean' in _hkey_basename: _titleY = '<p_{T} / p_{T}^{Offl}>'
       elif 'pt_overOffline_RMS' in _hkey_basename: _titleY = '#sigma(p_{T} / p_{T}^{Offl})'
       elif 'pt_overOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(p_{T} / p_{T}^{Offl}) / <p_{T} / p_{T}^{Offl}>'
       elif 'pt_overOffline' in _hkey_basename: _titleX = 'p_{T} / p_{T}^{Offl}'

       elif 'sumEt_minusGEN_Mean' in _hkey_basename: _titleY = '<SumEt - SumEt^{GEN}> [GeV]'
       elif 'sumEt_minusGEN_RMS' in _hkey_basename: _titleY = '#sigma(SumEt - SumEt^{GEN}) [GeV]'
       elif 'sumEt_minusGEN_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(SumEt - SumEt^{GEN}) / <SumEt / SumEt^{GEN}> [GeV]'
       elif 'sumEt_minusGEN' in _hkey_basename: _titleX = 'SumEt - SumEt^{GEN} [GeV]'

       elif 'sumEt_overGEN_Mean' in _hkey_basename: _titleY = '<SumEt / SumEt^{GEN}>'
       elif 'sumEt_overGEN_RMS' in _hkey_basename: _titleY = '#sigma(SumEt / SumEt^{GEN})'
       elif 'sumEt_overGEN_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(SumEt / SumEt^{GEN}) / <SumEt / SumEt^{GEN}>'
       elif 'sumEt_overGEN' in _hkey_basename: _titleX = 'SumEt / SumEt^{GEN}'

       elif 'sumEt_minusOffline_Mean' in _hkey_basename: _titleY = '<SumEt - SumEt^{Offl}> [GeV]'
       elif 'sumEt_minusOffline_RMS' in _hkey_basename: _titleY = '#sigma(SumEt - SumEt^{Offl}) [GeV]'
       elif 'sumEt_minusOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(SumEt - SumEt^{Offl}) / <SumEt / SumEt^{Offl}> [GeV]'
       elif 'sumEt_minusOffline' in _hkey_basename: _titleX = 'SumEt - SumEt^{Offl} [GeV]'

       elif 'sumEt_overOffline_Mean' in _hkey_basename: _titleY = '<SumEt / SumEt^{Offl}>'
       elif 'sumEt_overOffline_RMS' in _hkey_basename: _titleY = '#sigma(SumEt / SumEt^{Offl})'
       elif 'sumEt_overOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(SumEt / SumEt^{Offl}) / <SumEt / SumEt^{Offl}>'
       elif 'sumEt_overOffline' in _hkey_basename: _titleX = 'SumEt / SumEt^{Offl}'

       elif 'phi_minusGEN_Mean' in _hkey_basename: _titleY = '<#phi - #phi^{GEN}> [GeV]'
       elif 'phi_minusGEN_RMS' in _hkey_basename: _titleY = '#sigma(#phi - #phi^{GEN}) [GeV]'
       elif 'phi_minusGEN_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(#phi - #phi^{GEN}) / <#phi / #phi^{GEN}> [GeV]'
       elif 'phi_minusGEN' in _hkey_basename: _titleX = '#phi - #phi^{GEN} [GeV]'

       elif 'phi_overGEN_Mean' in _hkey_basename: _titleY = '<#phi / #phi^{GEN}>'
       elif 'phi_overGEN_RMS' in _hkey_basename: _titleY = '#sigma(#phi / #phi^{GEN})'
       elif 'phi_overGEN_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(#phi / #phi^{GEN}) / <#phi / #phi^{GEN}>'
       elif 'phi_overGEN' in _hkey_basename: _titleX = '#phi / #phi^{GEN}'

       elif 'phi_minusOffline_Mean' in _hkey_basename: _titleY = '<#phi - #phi^{Offl}> [GeV]'
       elif 'phi_minusOffline_RMS' in _hkey_basename: _titleY = '#sigma(#phi - #phi^{Offl}) [GeV]'
       elif 'phi_minusOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(#phi - #phi^{Offl}) / <#phi / #phi^{Offl}> [GeV]'
       elif 'phi_minusOffline' in _hkey_basename: _titleX = '#phi - #phi^{Offl} [GeV]'

       elif 'phi_overOffline_Mean' in _hkey_basename: _titleY = '<#phi / #phi^{Offl}>'
       elif 'phi_overOffline_RMS' in _hkey_basename: _titleY = '#sigma(#phi / #phi^{Offl})'
       elif 'phi_overOffline_RMSScaledByResponse' in _hkey_basename: _titleY = '#sigma(#phi / #phi^{Offl}) / <#phi / #phi^{Offl}>'
       elif 'phi_overOffline' in _hkey_basename: _titleX = '#phi / #phi^{Offl}'

       elif 'pt' in _hkey_basename: _titleX = 'p_{T} [GeV]'
       elif 'pt0' in _hkey_basename: _titleX = 'leading-jet p_{T} [GeV]'
       elif 'eta' in _hkey_basename: _titleX = '#eta'
       elif 'phi' in _hkey_basename: _titleX = '#phi'
       elif 'sumEt' in _hkey_basename: _titleX = 'Sum-E_{T} [GeV]'
       elif 'mass' in _hkey_basename: _titleX = 'mass [GeV]'
       elif 'dRmatch' in _hkey_basename: _titleX = '#DeltaR'
       elif 'mass' in _hkey_basename: _titleX = 'mass [GeV]'
       elif 'njets' in _hkey_basename: _titleX = 'number of jets'
       elif 'chargedHadronEnergyFraction' in _hkey_basename: _titleX = 'Charged-Hadron Energy Fraction'
       elif 'chargedHadronMultiplicity' in _hkey_basename: _titleX = 'Charged-Hadron Multiplicity'
       elif 'neutralHadronEnergyFraction' in _hkey_basename: _titleX = 'Neutral-Hadron Energy Fraction'
       elif 'neutralHadronMultiplicity' in _hkey_basename: _titleX = 'Neutral-Hadron Multiplicity'
       elif 'electronEnergyFraction' in _hkey_basename: _titleX = 'Electron Energy Fraction'
       elif 'electronMultiplicity' in _hkey_basename: _titleX = 'Electron Multiplicity'
       elif 'photonEnergyFraction' in _hkey_basename: _titleX = 'Photon Energy Fraction'
       elif 'photonMultiplicity' in _hkey_basename: _titleX = 'Photon Multiplicity'
