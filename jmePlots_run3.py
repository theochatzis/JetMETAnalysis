...
if __name__ == '__main__':
   ...
   for _hkey in th1Keys:
       ...
       if '_pt_paraToOffline_Mean_' in _hkey_basename: _titleY = '<p_{T}^{#parallel Offl}> [GeV]'
       elif '_pt_paraToOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(p_{T}^{#parallel Offl}) / <p_{T} / p_{T}^{Offl}> [GeV]'
       ...
       elif '_pt_paraToOfflineMinusOffline_Mean_' in _hkey_basename: _titleY = '<p_{T}^{#parallel Offl} - p_{T}^{Offl}> [GeV]'
       elif '_pt_paraToOfflineMinusOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(p_{T}^{#parallel Offl} - p_{T}^{Offl}) / <p_{T} / p_{T}^{Offl}> [GeV]'
       ...
       elif '_pt_perpToOffline_Mean_' in _hkey_basename: _titleY = '<p_{T}^{#perp Offl}> [GeV]'
       elif '_pt_perpToOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(p_{T}^{#perp Offl}) / <p_{T} / p_{T}^{Offl}> [GeV]'
       ...
       elif '_pt_minusGEN_Mean_' in _hkey_basename: _titleY = '<p_{T} - p_{T}^{GEN}> [GeV]'
       elif '_pt_minusGEN_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(p_{T} - p_{T}^{GEN}) / <p_{T} / p_{T}^{GEN}> [GeV]'
       ...
       elif '_pt_overGEN_Mean_' in _hkey_basename: _titleY = '<p_{T} / p_{T}^{GEN}>'
       elif '_pt_overGEN_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(p_{T} / p_{T}^{GEN}) / <p_{T} / p_{T}^{GEN}>'
       ...
       elif '_pt_minusOffline_Mean_' in _hkey_basename: _titleY = '<p_{T} - p_{T}^{Offl}> [GeV]'
       elif '_pt_minusOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(p_{T} - p_{T}^{Offl}) / <p_{T} / p_{T}^{Offl}> [GeV]'
       ...
       elif '_pt_overOffline_Mean_' in _hkey_basename: _titleY = '<p_{T} / p_{T}^{Offl}>'
       elif '_pt_overOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(p_{T} / p_{T}^{Offl}) / <p_{T} / p_{T}^{Offl}>'
       ...
       elif '_sumEt_minusGEN_Mean_' in _hkey_basename: _titleY = '<SumEt - SumEt^{GEN}> [GeV]'
       elif '_sumEt_minusGEN_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(SumEt - SumEt^{GEN}) / <SumEt / SumEt^{GEN}> [GeV]'
       ...
       elif '_sumEt_overGEN_Mean_' in _hkey_basename: _titleY = '<SumEt / SumEt^{GEN}>'
       elif '_sumEt_overGEN_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(SumEt / SumEt^{GEN}) / <SumEt / SumEt^{GEN}>'
       ...
       elif '_sumEt_minusOffline_Mean_' in _hkey_basename: _titleY = '<SumEt - SumEt^{Offl}> [GeV]'
       elif '_sumEt_minusOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(SumEt - SumEt^{Offl}) / <SumEt / SumEt^{Offl}> [GeV]'
       ...
       elif '_sumEt_overOffline_Mean_' in _hkey_basename: _titleY = '<SumEt / SumEt^{Offl}>'
       elif '_sumEt_overOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(SumEt / SumEt^{Offl}) / <SumEt / SumEt^{Offl}>'
       ...
       elif '_phi_minusGEN_Mean_' in _hkey_basename: _titleY = '<#phi - #phi^{GEN}> [GeV]'
       elif '_phi_minusGEN_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(#phi - #phi^{GEN}) / <#phi / #phi^{GEN}> [GeV]'
       ...
       elif '_phi_overGEN_Mean_' in _hkey_basename: _titleY = '<#phi / #phi^{GEN}>'
       elif '_phi_overGEN_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(#phi / #phi^{GEN}) / <#phi / #phi^{GEN}>'
       ...
       elif '_phi_minusOffline_Mean_' in _hkey_basename: _titleY = '<#phi - #phi^{Offl}> [GeV]'
       elif '_phi_minusOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(#phi - #phi^{Offl}) / <#phi / #phi^{Offl}> [GeV]'
       ...
       elif '_phi_overOffline_Mean_' in _hkey_basename: _titleY = '<#phi / #phi^{Offl}>'
       elif '_phi_overOffline_RMSScaledByResponse_' in _hkey_basename: _titleY = '#sigma(#phi / #phi^{Offl}) / <#phi / #phi^{Offl}>'
       ...
       elif '_pt0' in _hkey_basename: _titleX = 'leading-jet p_{T} [GeV]'
       elif '_pt' in _hkey_basename: _titleX = 'p_{T} [GeV]'
       elif '_eta' in _hkey_basename: _titleX = '#eta'
       elif '_phi' in _hkey_basename: _titleX = '#phi'
       elif '_sumEt' in _hkey_basename: _titleX = 'Sum-E_{T} [GeV]'
       elif '_mass' in _hkey_basename: _titleX = 'mass [GeV]'
